...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CounterSushi50Api.COUNTERTitleReport();
  });
  ...
  describe('COUNTERTitleReport', function() {
    it('should create an instance of COUNTERTitleReport', function() {
      // uncomment below and update the code to test COUNTERTitleReport
      //var instane = new CounterSushi50Api.COUNTERTitleReport();
      //expect(instance).to.be.a(CounterSushi50Api.COUNTERTitleReport);
    });
