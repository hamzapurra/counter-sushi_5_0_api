...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CounterSushi50Api.COUNTERTitleUsage();
  });
  ...
  describe('COUNTERTitleUsage', function() {
    it('should create an instance of COUNTERTitleUsage', function() {
      // uncomment below and update the code to test COUNTERTitleUsage
      //var instane = new CounterSushi50Api.COUNTERTitleUsage();
      //expect(instance).to.be.a(CounterSushi50Api.COUNTERTitleUsage);
    });
