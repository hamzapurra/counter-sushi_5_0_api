...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CounterSushi50Api.COUNTERItemPerformanceInstance();
  });
  ...
  describe('COUNTERItemPerformanceInstance', function() {
    it('should create an instance of COUNTERItemPerformanceInstance', function() {
      // uncomment below and update the code to test COUNTERItemPerformanceInstance
      //var instane = new CounterSushi50Api.COUNTERItemPerformanceInstance();
      //expect(instance).to.be.a(CounterSushi50Api.COUNTERItemPerformanceInstance);
    });
