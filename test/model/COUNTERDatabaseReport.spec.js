...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CounterSushi50Api.COUNTERDatabaseReport();
  });
  ...
  describe('COUNTERDatabaseReport', function() {
    it('should create an instance of COUNTERDatabaseReport', function() {
      // uncomment below and update the code to test COUNTERDatabaseReport
      //var instane = new CounterSushi50Api.COUNTERDatabaseReport();
      //expect(instance).to.be.a(CounterSushi50Api.COUNTERDatabaseReport);
    });
