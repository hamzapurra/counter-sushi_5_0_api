...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CounterSushi50Api.COUNTERPlatformReport();
  });
  ...
  describe('COUNTERPlatformReport', function() {
    it('should create an instance of COUNTERPlatformReport', function() {
      // uncomment below and update the code to test COUNTERPlatformReport
      //var instane = new CounterSushi50Api.COUNTERPlatformReport();
      //expect(instance).to.be.a(CounterSushi50Api.COUNTERPlatformReport);
    });
