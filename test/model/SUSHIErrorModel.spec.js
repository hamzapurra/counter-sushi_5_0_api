...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new CounterSushi50Api.SUSHIErrorModel();
  });
  ...
  describe('SUSHIErrorModel', function() {
    it('should create an instance of SUSHIErrorModel', function() {
      // uncomment below and update the code to test SUSHIErrorModel
      //var instane = new CounterSushi50Api.SUSHIErrorModel();
      //expect(instance).to.be.a(CounterSushi50Api.SUSHIErrorModel);
    });
