...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.CounterSushi50Api.ApiClient = factory(root.superagent, root.querystring);
  }
  ...
  var exports = function() {
     ...
     * @type {String}
     * @default https://virtserver.swaggerhub.com/opesch/counter-sushi_5_0_api/1.0.0
     */
    this.basePath = 'https://virtserver.swaggerhub.com/opesch/counter-sushi_5_0_api/1.0.0'.replace(/\/+$/, '');
    ...
    this.authentications = {
      ...
      'requestor_id': {type: 'apiKey', 'in': 'query', name: 'requestor_id'}
    };
    /**
